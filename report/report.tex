...
gc() 
\end{lstlisting}
This code will generate a 10000x10000 matrix filled with random 32 bit floating points, which consumes a bit of memory. \textbf{A} will be set to 0 and will keep the memory size of the 10000x10000 matrix until garbage collection is done either manually as in this example, or somewhere in the future when it is done automatically. 
