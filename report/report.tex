...
Programming in Julia can be done in the terminal like python:
\begin{figure}[H]
	\centering
...
\end{figure}
Making longer programs in the terminal might not be an optimal solution. The text editor Atom supports the Julia language. Atom has a package, \textbf{uber-juno}, which sets up Atom to act like an IDE, integrated development environment.
