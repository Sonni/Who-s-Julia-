...
%forklar hvad programmet skal gÃ¸re

\section{Design}
%hvordan projektet blev planlagt, hvilke tanker gik ind i hvordan problemet skulle lÃ¸ses
...
%hvad kom i frem til, gik noget galt? kunne noget gÃ¸res bedre?


\newpage

\section{Appendix (source code)}
%lstinputlisting tilfÃ¸jer jeres sourcecode, jeres python fil skal bare ligge i samme mappe som .tex filen husk at fjerne %
